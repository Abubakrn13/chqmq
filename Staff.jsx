          ...
          <tbody>
            {rows.map((x) => (
              <tr key={x.id}>
                ...
                <td>
                  {x.enabled ? <span className="pill ok">Faol</span> : <span className="pill out">O'chirilgan</span>}
                  {x.welcomeSent && <span className="pill" style={{ marginLeft: 6, background: "rgba(15,110,120,.14)", color: "var(--brand)" }} title="Xush kelibsiz xabari yuborilgan">✓ Xush kelibsiz</span>}
                </td>
